<link href="${url.resourcesPath}/css/verify.css" rel="stylesheet" />
<script src="${url.resourcesPath}/js/jquery.min.js" type="text/javascript"></script>
<script src="${url.resourcesPath}/js/verify.js" type="text/javascript"></script>
    ...
    <#elseif section = "form">
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
         ...
         <div class="form-group">
		    ...
		    type="submit"
		    value="${msg("doRegister")}" style="display:none"/>
                </div>
            </div>
        </form>
    </#if>
